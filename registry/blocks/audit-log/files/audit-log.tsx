...
/**
 * AuditLog — a chronological activity feed built on the WorkflowTimeline
 * primitive. Each entry shows an actor, an action, a timestamp, and an
 * optional tone badge. Use for record history, audit trails, and change logs.
 *
 * Swap the ENTRIES array for your real events.
 */
