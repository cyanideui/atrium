...
/**
 * Settings template — tabbed sectioned form with autosave.
 * Replace the mock autosave effect with your real save logic.
 */
...
// @atrium:endif
  ...
  const [bio, setBio] = React.useState(
    "Operations lead at Acme. Coffee, spreadsheets, and a soft spot for ledgers.",
  )
    ...
    <div className="flex flex-col gap-6">
      ...
      <Tabs defaultValue="profile">
        ...
        <TabsContent value="profile" className="mt-4 flex flex-col gap-4">
          <SettingsSection title="Identity" description="How you appear across the app.">
            <div className="flex items-center gap-4">
              ...
              <Button variant="tertiary" tone="critical">Remove</Button>
            </div>
            <FieldRow>
          ...
          <SettingsSection title="Localization" description="Affects timestamps, currencies, and numbers.">
            <FieldRow>
        ...
        <TabsContent value="notifications" className="mt-4 flex flex-col gap-4">
          <SettingsSection title="Channels" description="Choose where activity shows up.">
            <RowToggle
        ...
        <TabsContent value="security" className="mt-4 flex flex-col gap-4">
          <SettingsSection title="Two-factor authentication" description="Required for Pro plans and above.">
            <RowToggle
          ...
          <SettingsSection title="Sessions">
            <ChoiceList
              ...
              choices={[
                ...
                { value: "extended", label: "Stay signed in for 7 days", description: "Trusted devices only." },
        ...
        <TabsContent value="billing" className="mt-4">
          <SettingsSection title="Billing" description="Coming soon — managed via the workspace owner.">
            <p className="m-0 text-[13px] text-ink-3">
              Drop your invoice list and payment method form into this slot.
            </p>
          </SettingsSection>
        </TabsContent>
      </Tabs>
