 ...
 * sticky table + pagination + empty state. Drop-in starter for any
 * "list of records" page (orders, customers, products, invoices…).
 */
      ...
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 max-w-[640px] text-[13px] text-ink-3">
            Search, filter, and bulk-edit orders. Saved filter presets let you snap to the views you use most.
          </p>
        </div>
