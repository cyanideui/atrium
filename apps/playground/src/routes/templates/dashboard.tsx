...
/**
 * Dashboard template — drop-in ERP overview page. Pattern:
 *   1. Page header (title + primary actions)
 *   2. KPI tile row (4 metrics, each with sparkline + delta)
 *   3. Recent activity table
 *
 * Copy this file into your app, swap `KPIS` / `ORDERS` for real data
...
const KPIS: Kpi[] = [
  {
    ...
    delta: "+12.5%",
    up: true,
    spark: [12, 15, 14, 18, 22, 20, 24, 28, 27, 32, 30, 36],
  },
  {
    label: "Orders",
    value: "1,847",
    delta: "+8.2%",
    up: true,
    spark: [40, 38, 42, 45, 48, 47, 50, 52, 51, 55, 58, 60],
  },
  {
    label: "Pending",
    value: "342",
    delta: "−2.1%",
    up: false,
    spark: [80, 75, 78, 72, 70, 68, 65, 62, 60, 58, 55, 52],
  },
  {
    label: "Fulfillment",
    value: "98.2%",
    delta: "+0.4%",
    up: true,
    spark: [94, 95, 95, 96, 96, 97, 97, 98, 98, 98, 98, 98],
  },
]
      ...
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 max-w-[640px] text-[13px] text-ink-3">
            A drop-in dashboard layout. KPI tiles with inline sparklines, plus a recent-activity table. Copy this file into your app to get started.
          </p>
        </div>
