...
/**
 * Settings page — tabbed sectioned form with autosave.
 *
 * `"use client"` because the form is interactive. In a real app you'd
 * lift state into a server action / form mutation; here we keep it
 * self-contained so the page renders end-to-end without a backend.
 */
...
function FieldRow({ children }: { children: React.ReactNode }) {
  return (
    <div className="grid gap-1.5 sm:grid-cols-[160px_1fr] sm:items-start sm:gap-4">{children}</div>
  )
}
