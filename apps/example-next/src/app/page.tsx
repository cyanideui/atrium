...
/**
 * Dashboard page — server component (no "use client" because it's all
 * static markup + Atrium primitives). Demonstrates that Atrium components
 * compile cleanly through Next.js's App Router server-side rendering.
 */
