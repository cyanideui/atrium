...
/**
 * Orders list — direct port of the Atrium CRUD-list template, mounted at
 * `/orders` in the Next.js example app.
 *
 * `"use client"` because of useState/useMemo. In a real app, the data
 * would come from a server component or React Server Action, then this
 * file would just receive `initialOrders` as a prop.
 */
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section className="flex flex-wrap items-center gap-2">
        ...
        <SavedFilters filters={SAVED} value={filter} onChange={setFilter} />
            ...
            {visible.length === 0 ? (
              ...
              >
                {query ? (
                  ...
                  <Button size="sm" leading={<Icon icon={Add01Icon} size="sm" />}>
                    New order
                  </Button>
                )}
              </TableEmpty>
